...
// var featuredProductsTab = document.getElementById("featuredProducts");



// console.log(allProductsTab);
// console.log(trendingProductsTab);
// console.log(specialProductsTab);
// console.log(featuredProductsTab);
